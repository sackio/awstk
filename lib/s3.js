...
(function(){
  ...
  var S3 = function(O){
    ...
    S['writeFile'] = function(options, callback){
      ...
      return Async.waterfall([
        function(cb){
          ...
          a.o.Body = !Belt.isNull(a.o.file_data) ? new Buffer(a.o.file_data, a.o.ContentEncoding)
                                                 : FSTK._fs.createReadStream(a.o.file_path);
          return cb();
        }
      , function(cb){
    ...
    S['getGzipFile'] = function(options, callback){
      ...
      return Async.waterfall([
        function(cb){
          return self.getFile(a.o, Belt.cs(cb, gb, 'buf', 1, 0));
        }
      , function(cb){
    ...
    S['writeGzipFile'] = function(options, callback){
      ...
      return Async.waterfall([
        function(cb){
          var strm = !Belt.isNull(a.o.file_data) ? new Buffer(a.o.file_data, a.o.encoding)
                                                 : FSTK._fs.createReadStream(a.o.file_path);
          return Zlib.gzip(strm, Belt.cs(cb, gb, 'gzip', 1, 0));
        }
      , function(cb){
