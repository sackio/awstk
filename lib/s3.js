...
(function(){
  ...
  var S3 = function(O){
    ...
    S['getFile'] = function(bucket, path, options, callback){
      ...
      return Async.waterfall([
        function(cb){
          ...
          return S._API.getObject(req, Belt.callset(cb, globals, 'response', 1));
        }
      ], function(err){
        if (err) console.error(err);
    ...
    S['readdir'] = function(bucket, path, options, callback){
      ...
      return Async.waterfall([
        function(cb){
          return S._API.listObjects(req, Belt.callset(cb, globals, 'response'));
        }
      ], function(err){
        if (err) console.error(err);
    ...
    S['dirExists'] = function(bucket, path, options, callback){
      ...
      return Async.waterfall([
        function(cb){
          return S.readdir(bucket, path, a.options, Belt.callset(cb, globals, 'files'));
        }
      ], function(err){
        if (err) console.error(err);
    ...
    S['rmdir'] = function(bucket, path, options, callback){
      ...
      return Async.waterfall([
        function(cb){
          return S.readdir(bucket, path, Belt.callset(cb, globals, 'keys'));
        }
      , function(cb){
      ...
      return Async.waterfall([
        function(cb){
          return S.getFile(bucket, path, _.extend({}, a.options, {'return_buffer': true})
                          , Belt.callset(cb, globals, 'gzip'));
        }
      , function(cb){
          return Zlib.gunzip(globals.gzip, Belt.callset(cb, globals, 'body'));
        }
      ], function(err){
        if (err) console.error(err);
    ...
    S['writeGzipFile'] = function(bucket, path, body_str, options, callback){
      ...
      return Async.waterfall([
        function(cb){
          ...
          return Zlib.gzip(buf, Belt.callset(cb, globals, 'gzip'));
        }
      , function(cb){
    ...
    S['getJSON'] = function(bucket, path, options, callback){
      ...
      return Async.waterfall([
        function(cb){
          return S.getFile(bucket, path, a.options, Belt.callset(cb, globals, 'body'));
        }
      ], function(err){
        if (err) console.error(err);
