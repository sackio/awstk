  ...
  */
  S['describeInstance'] = function(options, callback){
    ...
    return Async.waterfall([
      function(cb){
        return Request(a.o.instance_data_url + '/latest/meta-data/instance-id', Belt.cs(cb, gb, 'id', 1, 0));
      }
    ], function(err){
      return a.cb(err, gb.id);
    });
  };
...
if (require.main === module){
  ...
  if (M.settings.argv.describeInstance) M.describeInstance(M.settings.argv, function(err, id){
